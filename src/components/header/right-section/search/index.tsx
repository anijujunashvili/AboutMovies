...
const SearchComp = () => {
  ...
  const customStyles = {
    ...
    content: {
      ...
      width: "50%",
      border: theme === "dark" ? "1px solid #374151" : "#fff",
      minHeight: "400px",
      marginRight: "-50%",
    ...
    <>
      <div>
        ...
        >
          <X
            onClick={closeModal}
            className="dark:text-secondary absolute right-4 cursor-pointer"
          />
          <div className="bg-background flex flex-col justify-between">
                ...
                render={({ field: { onChange, value } }) => {
                  return (
                    <Input
                      ...
                      className="focus:border-primary dark:text-secondary text-smoutline-none w-full rounded-none border-b bg-transparent py-3 pl-8 pr-8 shadow-none focus-visible:ring-0"
                    />
                  );
                }}
              />
              <Search className="dark:text-secondary absolute left-0 h-[18px] w-[18px] cursor-pointer" />
            </div>
            ...
            <div className="mt-6 flex flex-row flex-wrap gap-6">
              {searchResult?.map((res) => {
                return (
                  <div
                    className="flex max-h-[70px] cursor-pointer flex-row gap-2 border-b pb-2 hover:shadow-sm md:w-full lg:w-[45%] dark:border-gray-700"
                    key={res.id}
                  >
                    <img
                      src={
                      ...
                      className="h-full w-auto rounded-md dark:border-gray-400"
                    />
                    <div className="flex flex-col space-y-1">
                      <div className="dark:text-secondary mt-2 flex text-sm font-semibold hover:underline">
            ...
            <div
              className="dark:text-secondary absolute bottom-4 cursor-pointer text-gray-500 hover:underline"
